...
export const projects: Project[] = [
  ...
  },
  {
    ...
    id: "sf_touch_clinic",
    title: "sf touch clinic",
    description: "A welcoming digital space for patients to explore sf touch  clinic's practice, services, and professional background with intuitive navigation",
    image: "/sf.png",
    tags: ["Next.js", "TypeScript", "Tailwind CSS", "CMS", "i18n", "context"],
